...
$meta = [
    ...
    'description' => "Explore our customizable digital marketing packages designed to meet your business goals. Drive traffic, boost conversions, and grow your online presence today.",
      ...
      <div class="col-lg-4 col-md-6 mt-6 mt-lg-0">
        ...
        <div class="container mt-5">
            ...
            <div class="row gx-lg-2 align-items-center">
                <div class="col-lg-4 col-md-6 mt-6 mt-lg-0">
                    <div class="price-table">
                        <h3 class="price-title">Brand Building Kit </h3>
                ...
                <div class="col-lg-4 col-md-6 mt-6 mt-md-0">
                    <div class="price-table price-active">
                        ...
                        <h3 class="price-title">Growth Stratergy</h3>
                        <div class="price-list">
                            <ul class="list-unstyled">
                                <li>
                                    <i class="flaticon flaticon-check"></i>Profile Optimization
